...
//     return (
//       <div key={node.id} className="w-100 sm:w-full sm:max-w-[1800px] flex flex-col items-center">
...
const MyIBStructure = () => {
  ...
  const expandAll = () => setExpandedNodes(new Set([0, 1, 2, 3, 4, 5]));
  const collapseAll = () => setExpandedNodes(new Set([0]));
    ...
    return (
      ...
      >
        ...
        <div
          ...
          } text-white rounded-2xl shadow-xl p-4 sm:p-6 w-full min-w-[260px] sm:min-w-80 transition-all transform hover:scale-105`}
        >
          <div
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <div className="text-center p-2 bg-white/10 rounded-xl mt-2">
                <p className="text-xs opacity-80 mb-1">Total Lots</p>
                <p className="text-sm font-semibold">
                  {node.stats.totalLots.toFixed(4)}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mb-4 p-3 bg-white/10 rounded-xl">
              <p className="text-sm font-semibold mb-1">
                ...
                <span className="text-xl font-bold">
                  ${node.commission.toFixed(2)}
                </span>
              </p>
              <p className="text-xs opacity-80">
                From {node.commissionFrom} client(s) trading activity
              </p>
            </div>
          )}
          ...
          {hasChildren && (
            <button
              onClick={() => toggleNode(node.id)}
              className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-6 h-6 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50"
            >
              <svg
        ...
        {hasChildren && isExpanded && (
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 mt-8 px-4 overflow-x-auto pb-4 w-full">
            {node.children.map((child) => (
              <div key={child.id} className="flex-shrink-0">
                {renderNode(child)}
              </div>
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-violet-100 p-6">
          ...
          <p className="text-gray-600 text-lg">
            Complete IB hierarchy showing IBs and their clients
          </p>

          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl">
            <div className="flex items-center gap-2">
              <p className="text-blue-800 font-medium">
                Total Referrals in Tree: 5 users
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/90 rounded-2xl shadow-xl border border-violet-100 p-6">
            <div className="text-center">
              <h3 className="text-3xl font-bold">0.0000</h3>
              <p className="text-gray-600">Own Lots</p>
            </div>
          </div>

          <div className="bg-white/90 rounded-2xl shadow-xl border border-green-100 p-6">
            <div className="text-center">
              <h3 className="text-3xl font-bold">0.4000</h3>
              <p className="text-gray-600">Team Lots</p>
            </div>
          </div>
        ...
        <div className="bg-white/90 rounded-2xl shadow-xl border border-violet-100 p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold">My IB Structure</h3>

            <div className="flex gap-3">
              <button
                onClick={expandAll}
                className="px-4 py-2 bg-violet-500 text-white rounded-lg text-sm"
              >
                Expand All
              </button>
        ...
        <div className="bg-white/90 rounded-2xl shadow-xl border border-indigo-100 p-6">
          <h3 className="text-xl font-bold mb-4">Tree Legend</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 bg-violet-500 rounded-full"></div>
              <span>You (Root)</span>
