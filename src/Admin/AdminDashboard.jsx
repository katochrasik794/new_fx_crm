    ...
    <div className="min-h-screen bg-gray-900 text-white p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-400 mt-1">Realtime overview</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <p className="text-sm text-gray-400 mb-2">Active: 113 (100%)</p>
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center mb-3">
            ...
            <div>
              <p className="text-sm text-gray-400">Email Unverified</p>
              <p className="text-2xl font-bold">26</p>
            </div>
          </div>
          <p className="text-sm text-gray-400 mb-2">Of total users (23%)</p>
          <div className="w-full bg-gray-700 rounded-full h-2">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <p className="text-sm text-gray-400 mb-2">Pending vs users (1%)</p>
          <div className="w-full bg-gray-700 rounded-full h-2">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          <div className="flex items-center mb-3">
            ...
            <div>
              <p className="text-sm text-gray-400">Total MT5 Accounts</p>
              <p className="text-2xl font-bold">97</p>
            </div>
          </div>
          <p className="text-sm text-gray-400 mb-2">Accounts per user: 0.86</p>
          <div className="w-full bg-gray-700 rounded-full h-2">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-green-900 rounded-lg flex items-center justify-center mr-3">
            ...
            <div className="flex items-center">
              <div className="w-12 h-12 bg-yellow-900 rounded-lg flex items-center justify-center mr-3">
            ...
            <div className="flex items-center">
              <div className="w-12 h-12 bg-red-900 rounded-lg flex items-center justify-center mr-3">
                <svg className="w-6 h-6 text-red-400" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Rejected Deposits</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Rejected Withdrawals</p>
              </div>
            </div>
          </div>
          <div className="mt-4 pt-4 border-t border-gray-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            {[
              ...
              <div key={index} className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-400">{item.time} • MT5: {item.mt5}</p>
                  {item.txn && <p className="text-xs text-gray-500 break-all">Txn: {item.txn}</p>}
                </div>
                <div className="text-right ml-2">
                  <p className="font-bold text-sm">{item.amount}</p>
                  <span className={`inline-block px-2 py-1 text-xs rounded ${item.status === 'Approved' ? 'bg-green-900 text-green-300' : 'bg-yellow-900 text-yellow-300'}`}>
                    {item.status}
                  </span>
                </div>
              </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-700 flex justify-between items-center">
            <span className="text-xs text-gray-400">Showing last 5 results</span>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex justify-between items-start">
                ...
                <div className="text-right ml-2">
                  <p className="text-xs text-gray-400">MT5</p>
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">MT5</th>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Ref</th>
              </tr>
            </thead>
                ...
                <tr key={index} className="hover:bg-gray-700/50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                      item.status.toLowerCase() === 'approved' ? 'bg-green-900 text-green-300' :
                      item.status.toLowerCase() === 'pending' ? 'bg-yellow-900 text-yellow-300' :
                      item.status.toLowerCase() === 'rejected' ? 'bg-red-900 text-red-300' :
