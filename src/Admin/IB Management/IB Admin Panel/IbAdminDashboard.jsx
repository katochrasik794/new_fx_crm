...
const Dashboard = () => {
  return (
    <div className="w-full max-w-full p-4 md:p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen overflow-x-hidden">
      {/* Title */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">📊 IB Portal Admin Dashboard</h1>
        <p className="text-gray-600 text-lg">Advanced Pip-wise Commission Management System</p>
      </div>

      {/* KPI Row */}
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
        <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-5 border border-blue-100 hover:scale-105">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          <div className="bg-white rounded-xl shadow-lg border border-gray-200">
            <div className="px-6 py-5 border-b bg-gradient-to-r from-orange-50 to-amber-50 flex items-center justify-between">
              <h2 className="text-xl font-bold text-gray-800">Recent IB Requests</h2>
              <button className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:from-blue-600 hover:to-blue-700 shadow-md transition-all duration-300 hover:scale-105">Manage</button>
            </div>
            <div className="p-6">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b-2 border-gray-200 bg-gray-50">
                      <th className="text-left py-3 px-2 text-sm font-semibold text-gray-700">Applicant</th>
                      ...
                      <th className="text-left py-3 px-2 text-sm font-semibold text-gray-700">Applied</th>
                  ...
                  <tbody>
                    <tr className="border-b hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-2">
                        <div className="font-semibold text-sm text-gray-800">Abdul Rehman</div>
                        <div className="text-xs text-gray-500">mani3130882929@gmail.com</div>
                      </td>
                      <td className="py-4 px-2 text-sm font-semibold text-gray-700">$1.00</td>
                      <td className="py-4 px-2"><span className="bg-blue-500 text-white text-xs font-medium px-3 py-1 rounded-full">normal</span></td>
                      <td className="py-4 px-2 text-sm text-gray-600">2025-11-04 15:13</td>
                      <td className="py-4 px-2"><span className="bg-amber-500 text-white text-xs font-medium px-3 py-1 rounded-full">Pending</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <div>
          <div className="bg-white rounded-xl shadow-lg border border-gray-200">
            <div className="px-6 py-5 border-b bg-gradient-to-r from-emerald-50 to-green-50 flex items-center justify-between">
              <h2 className="text-xl font-bold text-gray-800">Recent Commission Ledger</h2>
              <button className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:from-emerald-600 hover:to-emerald-700 shadow-md transition-all duration-300 hover:scale-105">Open Ledger</button>
            </div>
            <div className="p-6">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b-2 border-gray-200 bg-gray-50">
                      ...
                      <th className="text-left py-3 px-2 text-sm font-semibold text-gray-700">IB</th>
                      <th className="text-left py-3 px-2 text-sm font-semibold text-gray-700">Symbol</th>
                      <th className="text-left py-3 px-2 text-sm font-semibold text-gray-700">Group</th>
                      <th className="text-left py-3 px-2 text-sm font-semibold text-gray-700">Lots</th>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={index} className="border-b hover:bg-gray-50 transition-colors">
                        <td className="py-4 px-2 text-sm text-gray-600">{row.date}</td>
                        <td className="py-4 px-2 text-sm font-medium text-gray-800">{row.ib}</td>
                        <td className="py-4 px-2"><span className="bg-cyan-500 text-white text-xs font-medium px-3 py-1 rounded-full">{row.symbol}</span></td>
                        <td className="py-4 px-2"><span className="bg-purple-500 text-white text-xs font-medium px-3 py-1 rounded-full">{row.group}</span></td>
                        <td className="py-4 px-2 text-sm text-gray-600">{row.lots}</td>
                        <td className="py-4 px-2 text-sm font-bold text-emerald-600">{row.commission}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
