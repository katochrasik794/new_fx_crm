...
const MasterArea = () => {
  ...
  return (
    <div className="min-h-screen bg-violet-100 p-4 md:p-6">
      <div className="w-[340px] sm:w-full max-w-[2800px] mx-auto">
        {/* Header */}
        <div className="mb-8">
  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <div>
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">
        Master Area - All Copy Trading Masters
      </h1>
      <p className="text-gray-600 mt-1 text-sm sm:text-base">
        Monitor and manage all copy trading masters and their performance
      </p>
    </div>

    {/* Stats Section */}
    <div className="grid grid-cols-2 sm:flex sm:items-center sm:space-x-4 gap-3 w-full md:w-auto">
      
      <div className="bg-white rounded-lg px-4 py-3 shadow-sm border border-gray-200">
        <div className="text-xs sm:text-sm text-gray-600">Total Masters</div>
      ...
      <div className="bg-white rounded-lg px-4 py-3 shadow-sm border border-gray-200">
        <div className="text-xs sm:text-sm text-gray-600">Active Masters</div>
      ...
      <div className="bg-white rounded-lg px-4 py-3 shadow-sm border border-gray-200">
        <div className="text-xs sm:text-sm text-gray-600">Total Copiers</div>
      ...
      <div className="bg-white rounded-lg px-4 py-3 shadow-sm border border-gray-200">
        <div className="text-xs sm:text-sm text-gray-600">Total AUM</div>
